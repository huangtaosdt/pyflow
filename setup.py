...
setup(
  ...
  url = 'https://github.com/huangtaosdt/pyflow',   # Provide either the link to your github or to your website
  download_url = 'https://github.com/huangtaosdt/pyflow/archive/refs/tags/v_01.tar.gz',    # I explain this later on
